	...
	render() {
		return (
			<ChartList>
                ...
                <DistributionChart chart={ (this.props.charts.data || {}).similarityPercent } filterChart={ (this.props.filterCharts.data || {}).similarityPercent } x="Percent of Code Similar" y="Student Comparison Count"/>
			</ChartList>
		)
	}
