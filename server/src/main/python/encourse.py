...
commitcount_parser.add_argument("logfile", type=argparse.FileType("r"), help="path to commit log file")
commitcount_parser.add_argument("name", help="user name")
commitcount_parser.add_argument("-O", "--obfuscate", action="store_true", help="obfuscate flag")
...
parsed_args = parser.parse_args(["commitcount", "test_datasets/sampleCommitList.txt", "cutz"])
parsed_args.func(parsed_args)
