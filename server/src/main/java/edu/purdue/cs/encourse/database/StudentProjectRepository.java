...
public interface StudentProjectRepository extends PagingAndSortingRepository<StudentProject, Long> {
    ...
    @Query("select s from StudentProjectDate s where " +
    ...
    List<StudentProject> findByProjectAndFilters(@NonNull Project project, @Param("filters") @NonNull CourseStudentFilters filters);
